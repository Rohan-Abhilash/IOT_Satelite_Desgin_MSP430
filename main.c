...
#define THRESHOLD_50 (3.3 * 0.5)  // 50% of 3.3V
#define THRESHOLD_30 (3.3 * 0.3)  // 30% of 3.3V
...
#define BAT_VOLT_SCL BIT7 //p1.7 for the clokc signal which els when the data is ready
